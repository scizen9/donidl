pro lcpar,czlimit=czlimit,exlimit=exlimit,inclimit=inclimit,merrlim=merrlim,$
	ps=ps,help=help
;
; SN Ia LC par plots
;
...
plot,[0,0],[1,1],/nodata,xthick=th,ythick=th,thick=th,charsi=si,charthi=th, $
	...
	ytitle=textoidl('HOST FUV - NUV'),yran=yrng,ysty=1
leg = strarr(nm)
;
; loop over apertures
;
...
plot,[0,0],[1,1],/nodata,xthick=th,ythick=th,thick=th,charsi=si,charthi=th, $
	...
	xran=cxrng,xsty=1,ytitle=textoidl('HOST FUV - NUV'),yran=yrng,ysty=1
leg = strarr(nm)
;
; loop over apertures
;
...
plot,[0,0],[1,1],/nodata,xthick=th,ythick=th,thick=th,charsi=si,charthi=th, $
	xtitle=textoidl('Light Curve Stretch'), xran=sxrng,xsty=1, $
	ytitle=textoidl('HOST FUV - K'),yran=yrng,ysty=1
leg = strarr(nm)
;
; loop over apertures
;
...
plot,[0,0],[1,1],/nodata,xthick=th,ythick=th,thick=th,charsi=si,charthi=th, $
	xtitle=textoidl('Light Curve Color: (B-V)_{Bmax} + 0.057'), $
	xran=cxrng,xsty=1,ytitle=textoidl('HOST FUV - K'),yran=yrng,ysty=1
leg = strarr(nm)
;
; loop over apertures
;
