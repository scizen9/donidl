pro dao_force_mags,ids,x,y,mags,merrs,chis,shrps,alflist,filts,root,offsets
...
; force magnitudes to reference frame
	...
	openw,flun,root+filts(flt)+'.frc',/get_lun
	printf,flun,'DAO_FORCE_MAGS: '+systime(0)
