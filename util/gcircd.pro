PRO gcircd,u,ra1,dc1,ra2,dc2,dis,radif,decdif
;+
; NAME:
;     GCIRCD
; PURPOSE:
...
;-
 ...
 npar = N_params()
 IF (npar lt 5) or (npar gt 8) THEN BEGIN
   print,'Calling sequence:  GCIRC,U,RA1,DC1,RA2,DC2[,DIS,RADIF,DECDIF]'
 ...
 radif = (rarad2-rarad1) * cos(dcrad1)
 decdif= dcrad2-dcrad1
