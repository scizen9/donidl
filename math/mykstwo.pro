 pro mykstwo, data1, data2, D, prob, sortdata1, fn1, sortdata2, fn2, pmax
;+
; NAME:
;       MYKSTWO
; PURPOSE:
...
;
; CALLING SEQUENCE:
;       mykstwo, data1, data2, D, prob, sortdata1, fn1, sortdata2, fn2, pmax
;
; INPUT PARAMATERS:
...
;	sortdata1,fn1	- cumulative distribution for data1:
;			plot,sortdata1,fn1,psym=10
;	sortdata2,fn2	- cumulative distribution for data2:
;			oplot,sortdata2,fn2,psym=10
;	pmax	- index in sortdata1 where max deviation occurs
;
; EXAMPLE:
