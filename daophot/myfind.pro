function myfind, image, x, y, flux, sharp, roundness, hmin, fwhm,  $
	roundlim, sharplim, PRINT = print, SILENT=silent
;+
; NAME:
;	MYFIND
; PURPOSE:
...
;
; CALLING SEQUENCE:
;	MYFIND, image, [ x, y, flux, sharp, round, hmin, fwhm, roundlim, sharplim 
;		PRINT= , /SILENT ]
;
; INPUTS:
...
;
; OPTIONAL INPUTS:
;	MYFIND will prompt for these parameters if not supplied
;
...
REJECT: 
 ...
 if not SILENT then begin
  ...
  if nstar LE 0 then return,0               ;Any stars found?
