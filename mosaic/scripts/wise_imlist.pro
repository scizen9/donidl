pro wise_imlist,lfile,ptslim,nosizelim=nosizelim
;+
; wise_imlist - create objmultipos.list file
;
...
;
objid=findgen(nobj)
cover_points,ra,dec,r,objid,allobj,allcoo,/wise
