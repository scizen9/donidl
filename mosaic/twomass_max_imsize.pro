function twomass_max_imsize, dir, verbose=verbose
;+
;	twomass_max_imsize - determine maximum image size based on
;		collection of 2mass images in dir
;
;-
; list of files to check
flist = file_search(dir+'*_aK_asky*fit*',count=nf)
;
