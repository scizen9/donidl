function sdss_max_imsize, dir, verbose=verbose
;+
;	sdss_max_imsize - determine maximum image size based on
;		collection of sdss images in dir
;
;-
; list of files to check
flist = file_search(dir+'fpC*g?-*fit*',count=nf)
;
